...
export class TokenBridgeContract extends ContractBase {
  ...
  public static deploy(rpc: PXE, ) {
    return new DeployMethod<TokenBridgeContract>(Point.ZERO, rpc, TokenBridgeContractAbi, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(rpc: PXE, publicKey: PublicKey, ) {
    return new DeployMethod<TokenBridgeContract>(publicKey, rpc, TokenBridgeContractAbi, Array.from(arguments).slice(2));
  }
  ...
  public methods!: {
    ...
    _initialize: ((token: { address: FieldLike }) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    claim_private: ((amount: FieldLike, secret_hash_for_redeeming_minted_notes: FieldLike, canceller: { address: FieldLike }, msg_key: FieldLike, secret_for_L1_to_L2_message_consumption: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** claim_public(to: struct, amount: field, canceller: struct, msg_key: field, secret: field) */
    claim_public: ((to: { address: FieldLike }, amount: FieldLike, canceller: { address: FieldLike }, msg_key: FieldLike, secret: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** exit_to_l1_private(recipient: struct, token: struct, amount: field, callerOnL1: struct, nonce: field) */
    exit_to_l1_private: ((recipient: { address: FieldLike }, token: { address: FieldLike }, amount: FieldLike, callerOnL1: { address: FieldLike }, nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** exit_to_l1_public(recipient: struct, amount: field, callerOnL1: struct, nonce: field) */
    exit_to_l1_public: ((recipient: { address: FieldLike }, amount: FieldLike, callerOnL1: { address: FieldLike }, nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
